...
#include "FrameAnimCaptureTool.generated.h"
...
class PROCEDURALCONTENTPROCESSOR_API UFrameAnimCaptureTool: public UProceduralWorldProcessor {
	GENERATED_BODY()
private:
...
private:
	...
	int BeginFrameCounter = -1;
	int CurrentFrameIndex = -1;
	FString CurrentName;
	FIntPoint CurrentScreenBoundsSize;
	FIntPoint CurrentBlockTextureSize;
	FIntPoint CurrentBlockCellSize;
	FIntPoint CurrentFrameTextureSize;
	TArray<FColor> FrameTextureData;
};